...
/***/ function(module, exports, __webpack_require__) {
	...
	var authDrink = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newDrink = function newDrink(success, failure, data) {
	  // debugger;
	  console.log(data);
	...
	var newIngredient = function newIngredient(success, failure, data) {
	  // debugger;
	  console.log(data);
	  console.log(app.token);
	  $.ajax({
	...
	var getIngredients = function getIngredients(success, failure) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + 'ingredients',
	    headers: {
	...
	var editIngredient = function editIngredient(success, failure, data, id) {
	  // debugger;
	  console.log(id);
	  console.log(app.token);
	  $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(4);
	var drinkApi = __webpack_require__(8);
	...
	var newDrinkSuccess = function newDrinkSuccess(data) {
	  // console.log(data);
	  // debugger;
	...
	var editDrankSuccess = function editDrankSuccess(data) {
	  app.drinkId = data.drink.id;
	  console.log(app);
	...
	var editIngredientSuccess = function editIngredientSuccess(data) {
	  app.ingredientId = data.id;
	...
	module.exports = {
	  ...
	  newDrinkSuccess: newDrinkSuccess,
	  newIngredientSuccess: newIngredientSuccess,
	  app: app,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDrank = function getDrank(success, failure) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + 'drinks',
	    headers: {
	...
	var editDrank = function editDrank(success, failure, data, drinkId) {
	  console.log(drinkId);
	  console.log(data);
	  $.ajax({
	    method: 'PATCH',
	...
	var deleteDrank = function deleteDrank(success, failure, drinkId) {
	  console.log(drinkId);
	  $.ajax({
	    method: 'DELETE',
	    url: app.api + 'drinks/' + drinkId,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"row\">\n  <div class=\"col-md-4 col-md-offset-4\">\n    "
	    ...
	    + "\n    <button type=\"button\" data-drink-id="
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " class=\"btn btn-default open-edit-drink\" data-dismiss=\"modal\" data-target=\"#editDrinkModal\">Spruce Things Up!</button>\n";
	  ...
	  return ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.data : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.ingredients : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
